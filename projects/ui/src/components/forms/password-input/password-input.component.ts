...
@Component({
  ...
  providers: [{ provide: InputComponent, useExisting: forwardRef(() => UiPasswordInput), multi: true }],
  imports: [FormsModule, NgIf, UiInputError],
})
export class UiPasswordInput implements ControlValueAccessor, InputInterface {
